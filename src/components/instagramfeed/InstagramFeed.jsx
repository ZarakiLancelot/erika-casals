...
const InstagramFeed = () => {
	...
	const reels = [
		...
		},
		{
			id: 2,
			type: 'embed',
			embedUrl: 'https://www.instagram.com/reel/DKpUbpatyoS/embed',
			title: 'LAY PROCENTE'
		},
		{
			id: 3,
			type: 'embed',
			embedUrl: 'https://www.instagram.com/reel/DJ9-iI0tkx1/embed',
			title: 'HOY TENGO LA HONOR DE ESTAR'
		},
		{
			id: 4,
			type: 'embed',
			embedUrl: 'https://www.instagram.com/reel/DKhhoIkto9G/embed',
			title: 'PROPIEDAD ENTRADA DE VENDER LA'
		},
		{
			id: 5,
			type: 'embed',
	...
	const nextSlide = () => {
		setCurrentSlide(prev => (prev === reels.length - 3 ? 0 : prev + 1));
	};

	const prevSlide = () => {
		setCurrentSlide(prev => (prev === 0 ? reels.length - 3 : prev - 1));
	};
