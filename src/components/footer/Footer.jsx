		...
		<StyledFooterContainer>
			...
			<StyledBottomSection>
				<StyledLeftBottom>
					...
					<StyledSocialIcons>
						<StyledSocialIcon href='#' aria-label='Facebook'>
							<svg
								width='20'
								height='20'
								viewBox='0 0 24 24'
						...
						<StyledSocialIcon href='#' aria-label='Instagram'>
							<svg
								width='20'
								height='20'
								viewBox='0 0 24 24'
						...
						<StyledSocialIcon href='#' aria-label='LinkedIn'>
							<svg
								width='20'
								height='20'
								viewBox='0 0 24 24'
					...
					<StyledBottomDescription>
						© 2024 your awesome website. All rights reserved.
					</StyledBottomDescription>
				</StyledLeftBottom>
				...
				<StyledRightBottom>
					...
					<StyledQuickLinks>
						<StyledQuickLink href='#inicio'>Inicio</StyledQuickLink>
						<StyledQuickLink href='#servicios'>Servicios</StyledQuickLink>
						<StyledQuickLink href='#sobre-mi'>Sobre mí</StyledQuickLink>
					</StyledQuickLinks>
				</StyledRightBottom>
			</StyledBottomSection>
		</StyledFooterContainer>
